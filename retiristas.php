	...
	if (confirm("Esta seguro de eliminar?")) {
   	...
   	function nuevoElemento(){
		...
		document.getElementById('frmRegistrar').reset();
                $("#titulo").html("Registrar retirista");
...
<ul class="nav nav-pills">
    <li id="b_hv"   data-contenido="hv"   ><a href="retiros.php">Retiros</a></li>
    <li id="b_asistente"   data-contenido="Asistente" class="active"><a href="#">Retiristas</a></li>
</ul>
...
<fieldset><legend><h1  style="text-align: center;"></h1></legend>
  ...
  ?>
  <form name="frmRegistrar" id="frmRegistrar"  action="guardarRetiristas.php" method="POST" class="form-horizontal">
        ...
        <div class="row">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><center><h3 id="titulo">Registrar retirista</h3></center></h3>
		...
		<div class="form-group">                    
                ...
                <div class="form-group" id="p_direccion">                    
                    <label for="ciudad" class="col-sm-3 control-label">Ciudad:</label>
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control validate[required]" id="ciudad" name="ciudad" placeholder="Ciudad">
                        </div>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <label for="ciudad" class="col-sm-3 control-label">Retiro:</label>
                    
                    <button type="button" class="btn btn-default">Retiro</button>
	...
	<br />
        <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><center><h3>Retiristas</h3></center></h3>
		...
		<table id="example" class="display dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
			...
			<tr role="row">
                    ...
                    <tbody>
                        <?php
                            include_once 'php/generated/GenerarHTMLRetiristas.php';
                            $g = new GenerarHTMLRetiristas();
                            $g->TablaRetiristas($valor[0]["permiso_editar"], $valor[0]["permiso_eliminar"]);
                        ?>
                    </tbody>
                    <tfoot>
