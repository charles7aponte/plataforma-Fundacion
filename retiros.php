...
<script>
    ...
    function eliminarHv(id, Id, p_eliminar) {
        if(p_eliminar == 1){
    ...
    function editar(nombre, fecha_inicio, fecha_fin, descripcion, miid, permiso) {
        //procedimiento = "editar";
        if(permiso == 1){
            $("#titulo").html("Editar retiro");

            $('#txtNombres').val(nombre);
            $('#fec_inicio').val(fecha_inicio);
            $('#descripcion').val(descripcion);
            $('#fec_final').val(fecha_fin);        
            $("#miid").val(miid);
...
<ul class="nav nav-pills">
    <li id="b_hv"   data-contenido="hv"  class="active" ><a href="#">Retiros</a></li>
    <li id="b_asistente"   data-contenido="Asistente"><a href="retiristas.php">Retiristas</a></li>
</ul>
...
<fieldset><legend><h1  style="text-align: center;"></h1></legend>
    ...
    ?>
        <form name="frmRegistrar" id="frmRegistrar"  action="guardarRetiros.php" method="POST" class="form-horizontal">
        ...
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><center><h4 id="titulo">Registrar retiro</h4></center></h3>
                </div>
                <div class="panel-body" style="background-color: rgb(197, 225, 250); ">
                    <!-- columna iz1  <div class="panel-body" style="background-color: rgb(197, 225, 250); ">  -->
                    <div class="col-md-6">
                        <br />
                        ...
                        <div class="form-group" >                    
                            ...
                            <div class="col-sm-9">
                                <input type="text"  name="fec_inicio"
                                           class ="form-control validate[required] mifecha" id="fec_inicio" placeholder="AAAA-MM-DD">
                            </div>
                        </div>
                    </div>
                    <!-- columna dere-->
                        ...
                        <div class="form-group" >                    
                            ...
                            <div class="col-sm-9">
                                <input type="text"  name="fec_final"
                                           class ="form-control validate[required] mifecha" id="fec_final" placeholder="AAAA-MM-DD">
                            </div>
                        </div>
                    </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><center><h4>Retiros</h4></center></h3>
    ...
    <div class="panel-body" style="background-color: rgb(197, 225, 250); ">
        ...
        <table id="example" class="display dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
            ...
            <tbody>
                <?php
                    include_once 'php/generated/GenerarHtmlRetiros.php';
                    $g = new generarHtmlRetiros();
                    $g->TablaRetiros($valor[0]["permiso_editar"], $valor[0]["permiso_eliminar"]);
                ?>
            </tbody>
            <tfoot>
