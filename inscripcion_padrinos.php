  ...
  function eliminarHv(id, Id){
	...
	if (confirm("Esta seguro de eliminar?")) {
   	...
   	function nuevoElemento(){
        ...
        $(".accionOtroAporte").click(function () {
          /*  if ($(this).is(':checked')) {
...
<ul class="nav nav-pills">
    <li id="b_hv"   data-contenido="hv"  class="active" ><a href="#">Padrinos</a></li>
    <li id="b_asistente"   data-contenido="Asistente"><a href="donaciones.php">Donacion de padrinos</a></li>
</ul>
...
<fieldset><legend><h1  style="text-align: center;"></h1></legend>
  ...
  ?>
      <form name="frmRegistrar" id="frmRegistrar"  action="guardarHv.php" method="POST" class="form-horizontal">
        ...
        <div class="row">
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><center><h4 id="titulo">Registrar padrino</h4></center></h3>
		...
		<div class="form-group" id="p_telefono">                    
			...
			<div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="valor" class="col-sm-3 control-label">Valor a donar:</label>

                    <div class="col-sm-9">
                        <input type="text"  name="valor" class="form-control validate[required,custom[onlyNumberSp]" id="valor" placeholder="Valor" >
                    </div>
	...
	<br />
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><center><h4 id="titulo">Padrinos</h4></center></h3>
