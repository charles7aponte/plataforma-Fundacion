...
<script>
    ...
    function editar(nombre, fecha_inicio, fecha_fin, descripcion, miid) {
        ...
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><center><h3 id="titulo">Registrar retiro</h3></center></h3>
                </div>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><center><h3>Retiros</h3></center></h3>
