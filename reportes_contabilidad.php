        ...
        if (dato.length > 0) {
            ...
            for (var i = 0; i < data.length; i++) {
                htmll += '<tr role="row" class="odd">'                        
                        ...
                        + '<td>' + data[i].egreso + '</td>'
                        + '<td><img src=\'images/ver.png\' onclick="verDetalles()" alt=\'\' title="Ver detalle" "style=\'cursor: pointer;\' ></td>'
            ...
            <div class="col-md-6 col-xs-2">
                ...
                <div class="form-group">                    
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  name="fecha_inicial" id="mesInicial"   class ="form-control mifecha" placeholder="AAAA-MM-DD">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-xs-2">
                ...
                <div class="form-group">                    
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  name="fecha_inicial" id="mesFinal"   class ="form-control mifecha" placeholder="AAAA-MM-DD">
                        </div>
                    </div>
                </div>
...
<br />
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">
             <h3 class="panel-title"><center><h4 id="titulo"></h4></center></h3>
          </div>
             <div class="panel-body" style="background-color: rgb(197, 225, 250); ">
