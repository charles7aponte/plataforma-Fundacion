...
$pdf->Write(0, 'Comprobante egreso FHOFNA', '', 0, 'L', true, 0, false, false, 0);
...
if(isset($_GET["accion"])){
  ...
  $datos=DAOFactory::getEgresosDAO()->queryById($_GET["accion"]);
    ...
    $tbl = '
        <table  border="1px"   style="WIDTH:100%;"> <!-- Lo cambiaremos por CSS  rowspan="3"-->
            <tr>
                ...
                <td style="height:30px"><label style="font-size:20px;"><strong>Comprobante de egreso</strong></label></td>
            </tr>
            <tr>
                <td colspan="2" style="height:30px"><label style="font-size:20px;">MZ. C Casa No.3 conj. Ciudad salitre</label></td>
                <td rowspan="2" style="height:30px"> <label style="font-size:30px; color: red;">Nº '.$datos->idegresos.'</label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="height:30px">Recibido de: <br /><label style="font-size:20px;">'.$datos->pagadoA.' </label></td>
